...
### Aim
To create a cloud instance in the AWS server for creating cloud storage (S3 Bucket).  
...
### Aim
To create a virtual machine instance in the AWS server using EC2.  
